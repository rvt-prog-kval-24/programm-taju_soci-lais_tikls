            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/202.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">Div Forum</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">DivHub</a>
                        <br><br><br>
